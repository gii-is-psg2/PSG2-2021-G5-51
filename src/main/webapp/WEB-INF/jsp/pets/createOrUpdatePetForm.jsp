...
<petclinic:layout pageName="owners">
    ...
    <jsp:body>
        <h2>
            <c:if test="${pet['new']}"><spring:message code="new-f"/> </c:if> <spring:message code="pet"/>
        </h2>
        <form:form modelAttribute="pet"
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <c:choose>
                        <c:when test="${pet['new']}">
                            <button class="btn btn-default" type="submit"><spring:message code="pet.new"/></button>
                        </c:when>
                        <c:otherwise>
                            <button class="btn btn-default" type="submit"><spring:message code="pet.edit"/></button>
                        </c:otherwise>
                    </c:choose>
                </div>
            </div>
