...
public class VisitController {
	...
	@GetMapping(value="/owners/{ownerId}/pets/{petId}/visit/{visitId}/delete")
	public String deleteVisit(@PathVariable final int petId,@PathVariable final int ownerId,@PathVariable final int visitId, final Map<String, Object> model) {
